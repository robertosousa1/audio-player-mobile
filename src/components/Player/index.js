...
import { Container, CoverBackground, EpisodeInfo, Title, Author, Controls, ControlButton, ControlIcon } from './styles';

const Player = ({ player, currentEpisode, play, pause, prev, next }) => player.current && (
  <Container>
